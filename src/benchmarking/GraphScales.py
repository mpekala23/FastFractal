...
def main():
  ...
  results_folder = "./output/benchmarking/resizing/results"
  graphs_folder = "./output/graphs/" + name_without_extension + "/"
  ...
  (ctime_fig, ctime_ax) = make_plot(initial_sizes, compress_times, image_name + " Compression Time", "Initial Size", "Compression Time (ms)")
